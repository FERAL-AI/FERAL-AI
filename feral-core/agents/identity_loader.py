...
class IdentityLoader:
    ...
    async def build_system_prompt(
        ...
        prompt += (
            ...
            "  For temporal-recall questions ('what did I do yesterday', 'summarize my morning',\n"
            "  'last Tuesday', 'what happened today', 'earlier today', 'recap my day'), call\n"
            "  **notes_memory__fused_timeline** — it fuses episodes, notes, knowledge, calendar, and\n"
            "  health into one chronological card. Do NOT answer from the `## Memory` block alone;\n"
            "  that block is only a working-set hint, not the full window.\n"
