...
description: "Connect physical devices to the FERAL mesh using the Hardware Unification Protocol."
---

# Writing a HUP Device Adapter

<Note>
  Looking to pair a phone from the dashboard? Use [Pairing & Access](/guides/pairing-access). This page is for building custom HUP adapters.
</Note>
