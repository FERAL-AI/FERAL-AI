...
FERAL treats robots as first-class hardware nodes. Any actuator — robotic arms, mobile platforms, drones, custom builds — can connect to the brain through the Hardware Unification Protocol (HUP). The brain sends commands, receives sensor data, and can orchestrate multi-robot workflows through natural language.
