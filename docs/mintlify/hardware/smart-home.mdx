...
For supported devices, FERAL can bypass Home Assistant and control hardware directly over the local network or BLE using the Hardware Unification Protocol.
