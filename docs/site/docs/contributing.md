...
| **GenUI / Provider Surfaces** | SDUI engine, provider contracts, surface caching, client renderer | `feral-core/genui/`, `feral-client-v2/src/ui/SduiRenderer.jsx` |
...
| **Frontend / Shell** | Web UI, dashboard, Tauri desktop, mobile bridges | `feral-client-v2/`, `desktop/` |
